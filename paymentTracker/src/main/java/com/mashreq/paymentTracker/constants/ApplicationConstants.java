...
public class ApplicationConstants {
	...
	public static final String DATA_SOURCE_CREATION_MSG = "DataSource Created Successfully";
	public static final String DATA_SOURCE_DELETION_MSG = "DataSource deleted successfully for this Id";
	public static final String DATA_SOURCE_CONFIG_DOES_NOT_EXISTS = "DataSource not exist with this id :";
	public static final String DATA_SOURCE_UPDATE_MSG = "DataSource Updated Successfully";

	/** Reports constants */
	public static final String REPORT_CREATION_MSG = "Report Created Successfully";
	public static final String REPORT_DELETION_MSG = "Report Configuration deleted";
	public static final String REPORT_DOES_NOT_EXISTS = "Report does not exist :";
	public static final String REPORT_UPDATE_MSG = "Report Configuration Updated Successfully";
	public static final String REPORT_EXECUTION_MSG = "Report Execution Success";
	public static final String REPORT_INSTANCE_CREATION_FAILED_MSG = "Report instance creation failed for the report";
	...
	public static final String METRICS_DOES_NOT_EXISTS = "Metrics not exist ";
	public static final String METRICS_UPDATE_MSG = "Metrics Updated Successfully";
	public static final String METRICS_NOT_AVAILABLE = "metrics not available";
	public static final String METRICS_DOES_NOT_EXISTS_FOR_REPORT = "Metrics not exist ";
	...
	public static final String COMPONENT_COUNTRY_DOES_NOT_EXISTS = "Component Country Details not exist";
	...
	public static final String MODULE_DOES_NOT_EXISTS = "Module not exist";
